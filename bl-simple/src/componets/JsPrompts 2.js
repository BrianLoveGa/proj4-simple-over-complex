  ...
  render() {
    return (
      <div className="JsPromptsContainer">
        ...
        <h3>
          On this page you can play the prompts version and access the original
          code to modify for your own game
        </h3>
        <Link className="code" to="/jsprompts/code">
          Click here for the prompts code
        </Link>
        <button id="clickMe" className="game" type="button" onClick={start_game}>
